...
describe('Unit', function () {
    ...
    describe('Record writers', function () {
        ...
        var communicationTestData = {
            'x': {
                'prov:informant': 'Bob'
            }
        };
        var specializationTestData = {
            'x': {
                'prov:agent': 'Alice',
                'prov:generalEntity': 'Person'
            }
        };
        var attributionTestData = {
            'x': {
                'prov:agent': 'Alice',
                'prov:type': 'rumor'
            }
        };
        var qualifiedAttributionTestData = {
            'x': {
                'prov:agent': 'Alice',
                'prov:type': 'rumor',
                'prov:role': 'editor'
        ...
        var associationTestData = {
            'x': {
                'prov:agent': 'Alice',
                'prov:role': 'editor'
            }
        };
        var generationTestData = {
            'x': {
        ...
        var usageTestData = {
            'x': {
                'prov:entity': 'Pamphlet1',
                'prov:time': '12:44'
            }
        };
        var derivationTestData = {
            'x': {
        ...
        describe('PROV-N', function () {
            ...
            it('Should give correct record for entity', function () {
                var rv = serializers.recordWriters.provN.entity({
                    'x': {
                        'prov:label': 'X'
                    }
                }, 'x');
            ...
            it('Should give correct record for was started by', function () {
                var rv = serializers.recordWriters.provN.wasStartedBy({
                    'x': {
                        'prov:time': '11111'
                    }
                }, 'x');
